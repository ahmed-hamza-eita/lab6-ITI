        ...
        val users =
            arrayListOf<PostModel>(
                PostModel(
                    ...
                    "11-10-2011",
                    Const.POST,
                    "https://img.icons8.com/?size=512&id=21441&format=png"
                ),
                PostModel(
                    "MOH hamza",
                    "11-11-2011",
                ...
                PostModel(
                    ...
                    "11-8-2011",
                    Const.POST,
                    "https://img.icons8.com/?size=512&id=81139&format=png"
                )
            )
        adapter.list = users
        binding.rv.adapter = adapter
        binding.txtEmail.text = MySharedPreferences.getUserEmail()
    }
